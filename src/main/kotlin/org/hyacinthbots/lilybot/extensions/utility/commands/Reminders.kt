...
class Reminders : Extension() {
    ...
    override suspend fun setup() {
        reminderTask =
            reminderScheduler.schedule(30, repeat = true, callback = ::postReminders, name = "Reminders task")
    ...
    inner class ReminderRemoveAllArgs : Arguments() {
        ...
        val type by stringChoice {
            ...
            choices = mutableMapOf(
                ...
                Translations.Utility.Reminders.Reminder.RemoveAll.Arguments.Type.Choices.nonRepeating to
                    "non-repeating",
