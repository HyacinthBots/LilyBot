                                ...
                                if (existingAction.data.reason?.contains("quick ban", true) == false) {
                                    when (existingAction.actionType) {
                                        ...
                                        ModerationAction.SOFT_BAN ->
                                            Translations.Events.Moderation.Ban.softBanned.translate()
                                        ModerationAction.TEMP_BAN ->
                                            Translations.Events.Moderation.Ban.tempBanned.translate()
                    ...
                    if (event.member.nickname == event.old?.nickname &&
                        ...
                        (
                            event.member.data != event.old?.data || event.member.avatar != event.old?.avatar ||
                                ...
                                event.member.isPending != event.old?.isPending ||
                                event.member.flags != event.old?.flags ||
