            ...
            ephemeralSubCommand(::UnlockChannelArgs) {
                ...
                action {
                    ...
                    actionLog.createEmbed {
                        title = Translations.Moderation.LockingCommands.Unlock.Channel.publicEmbedTitle.translate()
                        description =
                            Translations.Moderation.LockingCommands.Unlock.Channel.unlockConfirmation.translate(
                                targetChannel.mention
                            )
                        footer {
                            text = user.asUserOrNull()?.username ?: Translations.Basic.UnableTo.tag.translate()
            ...
            ephemeralSubCommand {
                ...
                action {
                    ...
                    if (everyoneRole == null) {
                        ...
                        respond {
                            content = Translations.Moderation.LockingCommands.Unlock.Server.notLocked.translate()
                        }
                        return@action
                    }
                    ...
                    respond {
                        content = Translations.Moderation.LockingCommands.Unlock.Server.unlockConfirmation.translate()
                    }
