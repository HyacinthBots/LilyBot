...
object ResponseHelper {
     ...
     * @author NoComment1105
     */
    suspend fun responseEmbedInActionLog(channel: GuildMessageChannelBehavior, embedTitle: String?, embedDescripton: String?, embedColor: Color?, requestedBy: User?): Message {
        return channel.createEmbed {
            title = embedTitle
